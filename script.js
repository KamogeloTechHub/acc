...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.service-card, .team-member, .testimonial, .about-content, .contact-content');
...
// Add data-target attributes to stats for animation
document.addEventListener('DOMContentLoaded', () => {
...
// Initialize tooltips for service cards (if needed)
document.querySelectorAll('.service-card').forEach(card => {
    const title = card.querySelector('h3').textContent;
    card.setAttribute('title', `Learn more about ${title}`);
});
...
console.log('Mabaso & Associates website loaded successfully!');
